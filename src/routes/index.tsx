...
const SKILLS = [
  ...
  {
    group: "Backend",
    items: ["Node.js", "Express.js", "RESTful APIs", "JWT Auth", "Middleware", "API Integration"],
  },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main id="top" className="mx-auto max-w-6xl px-5">
        {/* Hero */}
        <section className="reveal is-visible flex flex-col justify-center gap-6 py-20 md:py-32">
          ...
          <p className="max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            I build responsive, scalable web applications with MongoDB, Express.js, React.js and
            Node.js — from RESTful APIs and JWT authentication to polished, production-ready
            interfaces.
          </p>
          ...
          <dl className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              <div key={k} className="glow-card rounded-xl p-4" style={{ animationDelay: "160ms" }}>
        ...
        <Section id="about" title="About" kicker="01">
          <div className="grid gap-8 md:grid-cols-[1.4fr_1fr]">
            <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">
              I'm a Computer Science (AI) undergraduate at Technocrats Institute of Technology,
              Bhopal, focused on full-stack development. I enjoy designing clean APIs, integrating
              databases and shaping interfaces that feel fast and intuitive. Alongside code, I lead
              and organize hackathons and technical events — which has sharpened my collaboration,
        ...
        <Section id="education" title="Education" kicker="04">
          <ol className="reveal-stagger relative space-y-6 border-l border-border pl-6">
            {EDUCATION.map((e) => (
          ...
          <div className="glow-card rounded-3xl p-6 sm:p-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-display font-semibold">Rupesh_Vishwakarma_resume.pdf</p>
...
function Section({
  ...
  return (
    <section
      ref={sectionRef}
      id={id}
      className={`reveal scroll-mt-24 border-t border-border/60 py-16 md:py-24 ${isVisible ? "is-visible" : ""}`}
    >
